...
def valid_err_log(
    ...
    if log_errors == "PerAtomRMSE":
        ...
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, RMSE_E_per_atom={error_e:.2f} meV, RMSE_F={error_f:.2f} meV / A"
        )
    elif (
        ...
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, RMSE_E_per_atom={error_e:.2f} meV, RMSE_F={error_f:.2f} meV / A, RMSE_stress={error_stress:.2f} meV / A^3",
        )
    elif (
        log_errors == "PerAtomRMSEstressvirials"
        ...
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, RMSE_E_per_atom={error_e:.2f} meV, RMSE_F={error_f:.2f} meV / A, RMSE_virials_per_atom={error_virials:.2f} meV",
        )
    elif (
        ...
        logging.info(
            f"{inintial_phrase}: loss={valid_loss:.4f}, MAE_E_per_atom={error_e:.2f} meV, MAE_F={error_f:.2f} meV / A, MAE_stress={error_stress:.2f} meV / A^3"
        )
    elif (
        log_errors == "PerAtomMAEstressvirials"
        ...
        logging.info(
            f"{inintial_phrase}: loss={valid_loss:.4f}, MAE_E_per_atom={error_e:.2f} meV, MAE_F={error_f:.2f} meV / A, MAE_virials={error_virials:.2f} meV"
        )
    elif log_errors == "TotalRMSE":
        error_e = eval_metrics["rmse_e"] * 1e3
        error_f = eval_metrics["rmse_f"] * 1e3
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, RMSE_E={error_e:.2f} meV, RMSE_F={error_f:.2f} meV / A",
        )
    elif log_errors == "PerAtomMAE":
        error_e = eval_metrics["mae_e_per_atom"] * 1e3
        error_f = eval_metrics["mae_f"] * 1e3
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, MAE_E_per_atom={error_e:.2f} meV, MAE_F={error_f:.2f} meV / A",
        )
    elif log_errors == "TotalMAE":
        error_e = eval_metrics["mae_e"] * 1e3
        error_f = eval_metrics["mae_f"] * 1e3
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, MAE_E={error_e:.2f} meV, MAE_F={error_f:.2f} meV / A",
        )
        ...
        error_mu = eval_metrics["rmse_mu_per_atom"] * 1e3
        logging.info(
            f"{inintial_phrase}: head: {valid_loader_name}, loss={valid_loss:.4f}, RMSE_E_per_atom={error_e:.2f} meV, RMSE_F={error_f:.2f} meV / A, RMSE_Mu_per_atom={error_mu:.2f} mDebye",
        )
